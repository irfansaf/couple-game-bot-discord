  ...
  return [
    {
      ...
      content: [
        ...
        "If type is dare, respect playContext: e_meet means remote Discord/video/voice safe; meet means safe in-person actions are allowed.",
        ...aiPromptSafetyRules,
      ].join("\n"),
    },
    {
  ...
  return [
    {
      ...
      content: [
        ...
        "Do not reuse, lightly paraphrase, or ask the same idea as any item in recentQuestions.",
        "If type is dare, respect playContext: e_meet means every dare must work remotely through Discord/video/voice/chat; meet means safe in-person actions are allowed.",
        ...aiPromptSafetyRules,
      ].join("\n"),
    },
    {
